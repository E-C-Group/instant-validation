export declare type Rule = (val: any, ...insertedArgs: any[]) => boolean;
...
export declare type ErrorMessages<ComponentState> = {
    [key in keyof ComponentState]: string;
};
export interface RuleIdsInFields {
    [ruleId: string]: string[];
}
export declare type ChangedArgsFields = string[];
